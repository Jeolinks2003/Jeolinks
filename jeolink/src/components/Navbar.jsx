...
export default function ButtonAppBar() {
  ...
  return (
    <Box zIndex={20} sx={{ paddingY: '0',
      ...
      >
        <MenuItem onClick={handleClose} component={Link} to="/Directoriates">Research Services</MenuItem>
        <MenuItem onClick={handleClose} component={Link} to="/Directoriates">Technology Solutions</MenuItem>
        <MenuItem onClick={handleClose} component={Link} to="/Directoriates">Communication Services</MenuItem>
        <MenuItem onClick={handleClose} component={Link} to="/Directoriates">Educational Services</MenuItem>
      </Menu>
        ...
        >
          <Paper>
            <ClickAwayListener onClickAway={handleCloseTwo}>
              ...
              >
                <MenuItem onClick={handleCloseTwo} component={Link} to="/Community">O C P I</MenuItem>
              </MenuList>
            </ClickAwayListener>
          </Paper>
        </Grow>
